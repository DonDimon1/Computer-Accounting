...
void SMBIOS::ReadSMBIOS(){ //Чтение таблицы из БИОСа
    ...
    #ifdef _WIN32 // Реализация для Windows
...
QString SMBIOS::GetFormFactor(BYTE FormFactor){ // Получить форм фактор
    switch (FormFactor) {
        case 1: return "Other";
...
QString SMBIOS::GetMemoryType(BYTE MemoryType){ // Получить тип памяти
    switch (MemoryType){
    case 1: return "Other";
    case 2: return "Unknown";
    case 3: return "DRAM";
